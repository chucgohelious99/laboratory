...
class MultiTasking:
    ...
    def crossOver(self,a,b):
        ...
        child_a.extend(b.chromosome[t:])
        child_b.extend(a.chromosome[t:])
        ...
        for i in range(len(self.tasks)):
            if i!= ind_a.skillFactor:
                ...
                fitnessTa[i]=self.tasks[i].computeFitness(ind_a)
        ...
        for i in range(len(self.tasks)):
            if i!= ind_b.skillFactor:
                ...
                fitnessTa[i]=self.tasks[i].computeFitness(ind_b)
    ...
    def mutation(self,b):
        ...
        for i in range(len(self.tasks)):
            if i!= ind.skillFactor:
                ...
                fitnessTa[i]=self.tasks[i].computeFitness(ind)
